<%-- 
    Document   : HomePage
    Created on : Feb 18, 2021, 11:33:30 AM
            ...
            <div class="container-fluid bg-gradient p-5">
                ...
                <c:if test="${user.role eq 'Student'}">
                    <div class="row m-auto text-center w-75">
                        ...
                        <div class="col-5 princing-item red">
                            <div class="pricing-divider ">
                                <h3 class="text-light">PRJ311</h3>
                                <h4 class="my-0 display-2 text-light font-weight-normal mb-3"><span class="h1">JAVA Desktop</span></h4>
                            ...
                            <form action="takequiz">
                                <div class="card-body bg-white mt-0 shadow">
                                    <ul class="list-unstyled mb-5 position-relative">
                                        <li><b>40</b> questions</li>
                                        <li><b>60</b> minutes</li>
                                    </ul>
                                    <button type="submit" class="btn btn-lg btn-block  btn-custom ">Take quiz now</button>
                                    <input type="hidden" name="subjectID" value="PRJ311" />
                                </div>
                            </form>
                        </div>


                        <div class="col-5 princing-item blue">
                            <div class="pricing-divider ">
                                <h3 class="text-light">PRJ321</h3>
                                <h4 class="my-0 display-2 text-light font-weight-normal mb-3"><span class="h1">JAVA Web</span> </h4>
                                <svg class='pricing-divider-img' enable-background='new 0 0 300 100' height='100px' id='Layer_1' preserveAspectRatio='none' version='1.1' viewBox='0 0 300 100' width='300px' x='0px' xml:space='preserve' xmlns:xlink='http://www.w3.org/1999/xlink' xmlns='http://www.w3.org/2000/svg' y='0px'>
                                <path class='deco-layer deco-layer--1' d='M30.913,43.944c0,0,42.911-34.464,87.51-14.191c77.31,35.14,113.304-1.952,146.638-4.729
                                      c48.654-4.056,69.94,16.218,69.94,16.218v54.396H30.913V43.944z' fill='#FFFFFF' opacity='0.6'></path>
                                <path class='deco-layer deco-layer--2' d='M-35.667,44.628c0,0,42.91-34.463,87.51-14.191c77.31,35.141,113.304-1.952,146.639-4.729
                            ...
                            <form action="takequiz">
                                <div class="card-body bg-white mt-0 shadow">
                                    <ul class="list-unstyled mb-5 position-relative">
                                        <li><b>50</b> questions</li>
                                        <li><b>80</b> minutes</li>
                                    </ul>
                                    <button type="submit" class="btn btn-lg btn-block  btn-custom ">Take quiz now</button>
                                    <input type="hidden" name="subjectID" value="PRJ321" />
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <!--Quiz cards------------------------------------------>
                <c:if test="${user.role eq 'Admin'}">
                    <button class="btn" onclick="location.href = 'createQuestion.jsp'">Create New Question</button>
                                    ...
                                    <div class = "panel-body">
                                        <ul class = "list-group">
                                            ...
                                            <c:if test="${not empty ans_list}">
                                                ...
                                                <br>
                                                <form class="list-group" action="updateQuestion" method="POST" accept-charset="UTF-8">
                                                    <input type="hidden" name="txtQuestionID" value="${question.id}" />
                                                    <button class="btn-outline-success btn" type="submit">Update Question</button>
                                                </form>
                                                <form class="list-group" action="deleteQuestion" method="POST" accept-charset="UTF-8">
                                                    <input type="hidden" name="txtQuestionID" value="${question.id}" />
                                                    <button class="btn" type="submit" onclick="return confirm('Are you sure you want to delete')">Delete Question</button>
                                                </form>
