...
//            
    ...
    <body>
        ...
        <c:if test="${not empty user}">
            ...
            <form action="submitQuiz" id="quizstart" method="POST">
                ...
                <c:if test="${not empty map}">
                    ...
                    <c:if test="${not empty q_list}">
                        ...
                        <c:forEach var="question" items="${q_list}" varStatus="counter">
                            ...
                            <div class="row bg-gradient input-group">
                                ...
                                <div class="panel panel-primary ">
                                    <div class="panel-heading ">                  
                                        <pre>${counter.count}. ${question.content} </pre>
                                    </div><!--.panel-heading-->

                                    <div class = "panel-body">
                                        <ul class = "list-group">
                                            <c:set var="ans_list" value="${map.get(question.id)}"/>
                                            <c:if test="${not empty ans_list}">
                                                <c:forEach var="answer" items="${ans_list}">

                                                    <li class = "list-group-item">
                                                        <div class="funkyradio-primary">
                                                            <input type="checkbox" value="${answer.id}" name="radio" id="radio" onclick="onlyOne(this)"/>
                    ...
                    <div class="questionsRow"><button type="submit" class="button" id="nextquestions" value="submit"
