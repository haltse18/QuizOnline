    ...
    <body>
        ...
        <c:if test="${not empty user}">
            ...
            <div class="container-fluid bg-gradient p-5">
                ...
                <c:set var="quiz" value="${requestScope.QUIZDTO}"/>
                <c:if test="${not empty q_list}">
                    Subject: ${quiz.subjectID}</br>
                    Mark: ${quiz.mark}</br>
                    Date: ${quiz.time}</br> </br>
                                                ...
                                                <c:if test="${answer.check}">
                                                    <li class = "list-group-item">
                                                        <div class="funkyradio-primary">
                                                            <input type="checkbox" name="radio" id="radio" checked="checked" disabled="true"/>
                                                ...
                                                <c:if test="${!answer.check}">
                                                    <li class = "list-group-item">
                                                        <div class="funkyradio-default">
                                                            <input type="checkbox" name="radio" id="radio" disabled="true"/>
                                                ...
                                                <c:if test="${answer.correct}">
                                                    <li class = "list-group-item">
                                                        <div class="funkyradio-default">
                                                            ...
                                                            <label style="font-weight: bolder; color: green;">Correct answer: ${answer.content}</label>
                                                        </div>
                                                    </li>
                                                </c:if>
                                            </c:forEach>
